...
htmlhelp_basename = 'e-machinedoc'
...
latex_documents = [
    (master_doc, 'e-machine.tex', 'e-machine Documentation',
...
man_pages = [
    (master_doc, 'e-machine', 'e-machine Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'e-machine', 'e-machine Documentation',
     author, 'e-machine', 'One line description of project.',
     'Miscellaneous'),
]
